...
if transitionProbabilitiesImplemented
    % TODO: Question a)
   INDEX  = ComputeTerminalStateIndex(stateSpace, map);
end
TERMINAL_STATE_INDEX = INDEX(1);
STARTING_STATE_INDEX = INDEX(2);
...
if transitionProbabilitiesImplemented
    ...
    % TODO: Question b)
    P = ComputeTransitionProbabilities(stateSpace, map, map_index);
end
...
if stageCostsImplemented
    ...
    % TODO: Question c)
    G  = ComputeStageCosts(stateSpace, map, map_index);
end
